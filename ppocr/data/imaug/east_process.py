...
class EASTProcessTrain(object):
    def __init__(self,
        ...
        self.random_scale = np.array([0.6,0.8,1,1.2,1.4,1.6])
    ...
    def __call__(self, data):
        ...
        #add rotate cases
        # if np.random.rand() < 0.5:    # rotate image with 90 / 180 / 270 degre
        ...
        # jpg = np.array(score_map*100)
        # jpg = np.transpose(jpg, (1, 2, 0))
        # cv2.imwrite('score_map.jpg',jpg)
        # jpg = np.array(training_mask*100)
        # jpg = np.transpose(jpg, (1, 2, 0))
        # cv2.imwrite('training_mask.jpg',jpg)
